...
void CRWTable::WriteCSV()
{
	...
	if (fdlg.DoModal() == IDOK)
	{
		...
		strTitle = _T("序号,开始时间,异常代码,异常持续时间,异常信息\n");
...
{
	CStdioFile file;
	if (file.Open(strpath, CStdioFile::modeNoTruncate | CStdioFile::modeCreate | CStdioFile::modeReadWrite | CStdioFile::typeText))	 //打开文件
	{
		file.SeekToEnd();
		USES_CONVERSION;
