...
public:
	...
	int HttpGet(LPCTSTR strUrl, CString& strResponse, CString& strStatus);
	int HttpPost(LPCTSTR strUrl, LPCTSTR strPostData, CString& strResponse, CString& strStatus);

private:
	int ExecuteRequest(LPCTSTR strMethod, LPCTSTR strUrl, LPCTSTR strPostData, CString& strResponse, CString& strStatus);
